...
In each experiment the same 8 orientations were used:  
...
## Experiment 1 - scale(sigma) = 1.5 , wavelength(lambda) = 4: 
...
## Experiment 2 - (sigma) = 1.5 , wavelength(lambda) = 8:
...
## Experiment 3 - (sigma) = 1.5 , wavelength(lambda) = 12:
...
## Experiment 5 - scale(sigma) = 2.5 , wavelength(lambda) = 8:
...
## Experiment 6 - scale(sigma) = 2.5 , wavelength(lambda) = 12:
